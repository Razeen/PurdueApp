...
class MessagesCell: UITableViewCell {
    ...
    let readView = UIView(frame: CGRectMake(UIScreen.mainScreen().bounds.width - 30 - 35 - 15, 14, 10, 10))
    ...
    let timeLabel = UILabel(frame: CGRectMake(UIScreen.mainScreen().bounds.width - 30 - 35, 10, 30, 20))
